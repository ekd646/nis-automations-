...
const App = () => {
    ...
    return (
        <div className="bg-background text-on-background font-body antialiased min-h-screen relative">
                    ...
                    <div className="bg-[#0a2e45] dark:bg-[#0a2e45] border border-[#92b844]/30 dark:border-[#92b844]/30 rounded-2xl p-8 max-w-md w-full relative shadow-2xl transform transition-transform duration-300 scale-100">
                        ...
                        {modalMode === 'strategy' && (
                            <div className="animate-fade-in transition-all">
                                ...
                                <button 
                                    ...
                                    className="w-full bg-[#1978e5] text-[#0a2e45] py-3.5 rounded-xl font-bold hover:bg-[#0a2e45] transition-colors shadow-lg shadow-blue-500/20 hover:scale-[1.02] disabled:opacity-50"
                                >
                        ...
                        <div className="mt-4 pt-4 text-center">
                            ...
                            <div className="flex justify-center items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100">
                                <div className="bg-[#0a2e45] px-2 py-0.5 rounded shadow-sm flex items-center justify-center border border-gray-300 h-6"><span className="text-[#142A7C] font-extrabold text-[11px] tracking-tighter">VISA</span></div>
                                ...
                                <div className="bg-[#0a2e45] px-2 py-0.5 rounded shadow-sm flex items-center justify-center border border-gray-300 h-6"><div className="flex"><div className="w-3 h-3 rounded-full bg-red-500/90 mix-blend-multiply relative left-1 z-10"></div><div className="w-3 h-3 rounded-full bg-yellow-500/90 mix-blend-multiply relative right-1"></div></div></div>
                                <div className="bg-[#0a2e45] px-2 py-0.5 rounded shadow-sm flex items-center justify-center border border-gray-700 h-6"><span className="text-[#0a2e45] font-bold text-[11px]"> Pay</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <header className="fixed top-0 w-full z-50 bg-[#0a2e45]/80 dark:bg-[#0a0a0c]/80 backdrop-blur-md border-b border-[#92b844]/30 dark:border-[#92b844]/30 shadow-sm">
            ...
            <main className="pt-24 min-h-screen">
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="z-10 animate-hero">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button onClick={() => { setModalMode("strategy"); setIsModalOpen(true); }} className="bg-primary text-on-primary px-8 py-4 rounded-xl font-bold text-lg hover:opacity-90 hover:shadow-lg hover:shadow-primary/20 transition-all flex items-center gap-2">
                                Launch Project <span className="material-symbols-outlined" translate="no">arrow_forward</span>
                            </button>
                            <button onClick={() => { setModalMode("signup"); setIsModalOpen(true); }} className="glass-card bg-[#0a2e45]/5 border border-white/10 text-on-background px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#0a2e45]/10 transition-all">
                                Try Dashboard Free
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="relative group animate-hero" style={{ animationDelay: '0.2s' }}>
                        <div className="absolute -inset-4 bg-[#1978e5] opacity-20 blur-3xl rounded-full"></div>
                        <div className="relative glass-card rounded-2xl p-6 blue-glow border-white/10 dark:bg-[#0a0a0c]/80 overflow-hidden shadow-2xl">
                            <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-[#1978e5] flex items-center justify-center shadow-lg">
                                        <span className="material-symbols-outlined text-[#0a2e45]" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold">Observice Automations Co. Engine</p>
                            ...
                            <div className="space-y-6" id="ai-chat-container">
                                <div className="flex gap-3 ai-message delay-300">
                                    ...
                                    <div className="bg-[#085f52] dark:bg-[#085f52] p-4 rounded-2xl rounded-tl-none text-sm max-w-[80%] font-medium">
                                        Analyze Q3 performance and suggest automation workflows for global supply chain.
                                    </div>
                                </div>
                                <div className="flex gap-3 flex-row-reverse ai-message delay-500">
                                    ...
                                    <div className="bg-[#1978e5] text-[#0a2e45] p-4 rounded-2xl rounded-tr-none text-sm max-w-[80%] shadow-lg font-medium leading-relaxed">
                                        ...
                                        <div className="mt-4 h-1.5 bg-[#0a2e45]/20 rounded-full overflow-hidden">
                                            <div className="w-4/5 h-full bg-[#0a2e45] relative"><div className="absolute inset-0 bg-[#0a2e45]/50 animate-pulse"></div></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="solutions" className="py-24 max-w-7xl mx-auto px-6 border-t border-[#92b844]/30 dark:border-[#92b844]/30">
                    <div className="mb-16 reveal-on-scroll">
                        <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">Our Core AI Services</h2>
                        <p className="text-on-surface-variant max-w-2xl text-lg">Select an implementation module below to view how Observice Automations Co. structures deterministic AI pipelines specifically for your sector.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-auto lg:h-[560px] reveal-on-scroll delay-100">
                        ...
                        <div className="lg:col-span-7 bg-[#0a0a0c] rounded-[32px] relative flex flex-col justify-end group transition-all duration-500 shadow-2xl overflow-hidden cursor-pointer" onClick={() => { setModalMode("signup"); setIsModalOpen(true); }}>
                            <div className="absolute inset-0 bg-[#0a2e45]">
                               <img alt={services[activeService].title} className="w-full h-full object-cover opacity-50 transition-all duration-700 ease-in-out group-hover:scale-105 group-hover:opacity-60" src={services[activeService].img} key={services[activeService].img} />
                               <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent"></div>
                               <div className="absolute top-6 right-6 px-4 py-1.5 rounded-full bg-[#0a2e45]/10 backdrop-blur-md border border-white/20 text-[#0a2e45] text-xs font-bold uppercase tracking-widest animate-pulse flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-green-500"></div> System Demo Active</div>
                            </div>
                            <div className="relative z-10 p-10 lg:p-12 pb-14 mt-auto">
                                <span className="material-symbols-outlined text-5xl mb-6 text-[#0a2e45] bg-[#1978e5] p-4 rounded-2xl shadow-[0_0_30px_rgba(25,120,229,0.5)] inline-block">{services[activeService].icon}</span>
                                <h3 className="text-4xl md:text-5xl font-extrabold mb-4 text-[#0a2e45]">{services[activeService].title}</h3>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {services[activeService].tags.map(tag => (
                                        <span key={tag} className="px-5 py-2 font-mono text-xs bg-[#0a2e45]/10 backdrop-blur-md rounded-xl text-[#0a2e45] font-bold tracking-widest uppercase border border-white/10 hover:bg-[#1978e5] hover:border-[#1978e5] transition-colors">{tag}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
                ...
                <section id="process" className="bg-[#085f52] dark:bg-[#0a2e45]/50 py-24 border-y border-[#92b844]/30 dark:border-[#92b844]/30">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-20 reveal-on-scroll">
                            <h2 className="text-4xl font-extrabold mb-6 tracking-tight">Our Deployment Process</h2>
                            <div className="w-24 h-1.5 bg-[#1978e5] rounded-full mx-auto"></div>
                        </div>
                ...
                <section className="py-24 max-w-7xl mx-auto px-6 text-center">
                    <div className="bg-[#0B3B7A] dark:bg-[#0a0a0c] border border-transparent dark:border-blue-900/50 text-[#0a2e45] rounded-[40px] p-12 md:p-24 relative overflow-hidden reveal-on-scroll shadow-2xl">
                        <div className="absolute inset-0 opacity-20">
                            <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,_#1978e5_0%,_transparent_60%)]"></div>
                        </div>
                        <div className="relative z-10">
                            <h2 className="text-4xl md:text-6xl font-extrabold mb-8 tracking-tighter shadow-sm">Ready to automate the future?</h2>
                            <p className="text-xl text-[#0a2e45]/80 mb-12 max-w-2xl mx-auto font-medium">Join the ranks of high-performance enterprises leveraging Observice Automations Co. architectures.</p>
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                <button onClick={() => { setModalMode("signup"); setIsModalOpen(true); }} className="bg-[#1978e5] text-[#0a2e45] px-10 py-5 rounded-2xl font-bold text-xl hover:scale-105 shadow-[0_10px_40px_rgba(25,120,229,0.4)] transition-all">
                                    Start Your Migration
                                </button>
                                <button onClick={() => { setModalMode("strategy"); setIsModalOpen(true); }} className="bg-[#0a2e45]/10 backdrop-blur-md text-[#0a2e45] border border-white/20 px-10 py-5 rounded-2xl font-bold text-xl hover:bg-[#0a2e45]/20 transition-all">
                                    Talk to an Expert
                                </button>
                            </div>
                        </div>
                ...
                <div className="flex flex-col justify-center items-center gap-10 max-w-7xl mx-auto px-8">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <div className="flex gap-3 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 items-center justify-center bg-gray-200/50 dark:bg-[#0a2e45]/50 px-6 py-3 rounded-2xl border border-[#92b844]/30 dark:border-[#92b844]/30">
                            <span className="bg-[#0a2e45] px-3 py-1.5 rounded shadow-sm border border-gray-100 text-[#142A7C] font-extrabold text-[12px] tracking-tighter">VISA</span>
                            <span className="bg-[#0a2e45] px-3 py-1.5 rounded shadow-sm border border-gray-100 flex items-center justify-center"><div className="flex"><div className="w-3.5 h-3.5 rounded-full bg-[#EA001B] mix-blend-multiply relative left-1.5 z-10"></div><div className="w-3.5 h-3.5 rounded-full bg-[#F79E1B] mix-blend-multiply relative right-1"></div></div></span>
                            ...
                            <span className="bg-[#0a2e45] dark:bg-[#0a2e45] px-3 py-1.5 rounded shadow-sm border border-[#92b844]/30 dark:border-gray-700 text-black dark:text-[#0a2e45] font-extrabold text-[12px]"> Pay</span>
                            <span className="bg-[#003087] px-3 py-1.5 rounded shadow-sm border border-[#003087] flex items-center"><span className="text-[#009cde] font-bold text-[11px]">Pay</span><span className="text-[#0a2e45] font-bold text-[11px]">Pal</span></span>
                        </div>
                    </div>
