    ...
    return (
        <div className="bg-background text-on-background font-body antialiased min-h-screen relative">
                ...
                <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
                    <a onClick={(e) => scrollToSection('hero', e)} href="#hero" className="flex items-center gap-2 group cursor-pointer">
                        ...
                        <div className="flex flex-col ml-3 hidden sm:flex">
                          <span className="text-xl md:text-2xl font-black tracking-widest text-gray-900 dark:text-white uppercase font-sans leading-none">Observice Automations <span className="text-[#1978e5]">Co.</span></span>
            ...
            <main className="pt-24 min-h-screen">
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="z-10 animate-hero">
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-8 tracking-tighter">
                            We Build <span className="text-[#1978e5]">Autonomous</span> Departments
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <button onClick={() => { setModalMode("signup"); setIsModalOpen(true); }} className="glass-card bg-white/5 border border-white/10 text-on-background px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition-all">
                                Try Dashboard Free
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="relative glass-card rounded-2xl p-6 blue-glow border-white/10 dark:bg-[#0a0a0c]/80 overflow-hidden shadow-2xl">
                            ...
                            <div className="space-y-6" id="ai-chat-container">
                                <div className="flex gap-3 ai-message delay-300">
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-2xl rounded-tl-none text-sm max-w-[80%] font-medium">
                                ...
                                <div className="flex gap-3 flex-row-reverse ai-message delay-500">
                                    ...
                                    <div className="bg-[#1978e5] text-white p-4 rounded-2xl rounded-tr-none text-sm max-w-[80%] shadow-lg font-medium leading-relaxed">
                                        ...
                                        <div className="mt-4 h-1.5 bg-black/20 rounded-full overflow-hidden">
                                            <div className="w-4/5 h-full bg-white relative"><div className="absolute inset-0 bg-white/50 animate-pulse"></div></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-auto lg:h-[560px] reveal-on-scroll delay-100">
                        ...
                        <div className="lg:col-span-7 bg-[#0a0a0c] rounded-[32px] relative flex flex-col justify-end group transition-all duration-500 shadow-2xl overflow-hidden cursor-pointer" onClick={() => { setModalMode("signup"); setIsModalOpen(true); }}>
                            <div className="absolute inset-0 bg-black">
                               ...
                               <div className="absolute top-6 right-6 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-bold uppercase tracking-widest animate-pulse flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-green-500"></div> System Demo Active</div>
                            </div>
                            <div className="relative z-10 p-10 lg:p-12 pb-14 mt-auto">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {services[activeService].tags.map(tag => (
                                        <span key={tag} className="px-5 py-2 font-mono text-xs bg-white/10 backdrop-blur-md rounded-xl text-white font-bold tracking-widest uppercase border border-white/10 hover:bg-[#1978e5] hover:border-[#1978e5] transition-colors">{tag}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
                ...
                <section id="process" className="bg-gray-50 dark:bg-gray-900/50 py-24 border-y border-gray-200 dark:border-gray-800">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            <div className="relative reveal-on-scroll">
                                <div className="text-[120px] font-extrabold text-[#1978e5]/10 absolute -top-16 -left-4 select-none mix-blend-multiply dark:mix-blend-screen">01</div>
                                <div className="relative z-10 bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-[#1978e5]/40 transition-colors shadow-sm">
                                    <h3 className="text-2xl font-bold mb-4 flex items-center gap-3"><span className="material-symbols-outlined text-[#1978e5]">search</span> Discovery</h3>
                            ...
                            <div className="relative reveal-on-scroll delay-200">
                                <div className="text-[120px] font-extrabold text-[#1978e5]/10 absolute -top-16 -left-4 select-none mix-blend-multiply dark:mix-blend-screen">02</div>
                                <div className="relative z-10 bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-[#1978e5]/40 transition-colors shadow-sm">
                                    <h3 className="text-2xl font-bold mb-4 flex items-center gap-3"><span className="material-symbols-outlined text-[#1978e5]">architecture</span> Architecture</h3>
                            ...
                            <div className="relative reveal-on-scroll delay-400">
                                <div className="text-[120px] font-extrabold text-[#1978e5]/10 absolute -top-16 -left-4 select-none mix-blend-multiply dark:mix-blend-screen">03</div>
                                <div className="relative z-10 bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-[#1978e5]/40 transition-colors shadow-sm">
                                    <h3 className="text-2xl font-bold mb-4 flex items-center gap-3"><span className="material-symbols-outlined text-[#1978e5]">deployed_code</span> Implementation</h3>
                ...
                <section className="py-24 max-w-7xl mx-auto px-6 text-center">
                    <div className="bg-[#0B3B7A] dark:bg-[#0a0a0c] border border-transparent dark:border-blue-900/50 text-white rounded-[40px] p-12 md:p-24 relative overflow-hidden reveal-on-scroll shadow-2xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto font-medium">Join the ranks of high-performance enterprises leveraging Observice Automations Co. architectures.</p>
                            <div className="flex flex-col md:flex-row justify-center gap-6">
                                ...
                                <button onClick={() => { setModalMode("strategy"); setIsModalOpen(true); }} className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-10 py-5 rounded-2xl font-bold text-xl hover:bg-white/20 transition-all">
                                    Talk to an Expert
                                </button>
                            </div>
                        </div>
